...
/* FIXME: update the TransitionView to display enabled/fireable transitions differently using an enabled property that
the widget updates after events are fired, and that the widget initializes in beginning after all nodes of graph are created :)
will need another .initTransitionEnabledStatuses function for prototype, then the view can read from that to change the render (color mainly)
/**
