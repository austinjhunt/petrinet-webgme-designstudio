"""
This script is called by the plugin-wrapper, PetriNetCategorizer.js, which passes down the
...
from PetriNetCategorizer import PetriNetCategorizer
...
plugin = PetriNetCategorizer(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
